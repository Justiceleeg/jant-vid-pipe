    ...
    <div className="w-full max-w-4xl mx-auto bg-card border-2 border-border rounded-lg overflow-hidden shadow-lg">
      ...
      <div className="p-8 space-y-6">
        ...
        {scene.state === 'image' && (
          <div className="space-y-6">
            {/* Image display */}
            <div className="relative aspect-video max-h-[600px] rounded-lg overflow-hidden bg-muted border border-border">
              {isGeneratingImage ? (
        ...
        {scene.state === 'video' && (
          <div className="space-y-6">
            {/* Video player */}
            <div className="relative aspect-video max-h-[600px] rounded-lg overflow-hidden bg-black border border-border">
              {isGeneratingVideo ? (
